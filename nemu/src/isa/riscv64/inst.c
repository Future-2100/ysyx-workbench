...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 000 ????? 00100 11", addi   , I, R(dest) = (word_t)(src1 + src2) ); //li,mv ---------
  ...
  INSTPAT("0100000 ????? ????? 000 ????? 01100 11", sub    , R, R(dest) = (word_t)(src1 - src2) ); //-----
  ...
  INSTPAT("??????? ????? ????? 000 ????? 00110 11", addiw  , I, R(dest) =   SEXT(BITS(src1 + src2,31,0),32) ); //sext.w---------
