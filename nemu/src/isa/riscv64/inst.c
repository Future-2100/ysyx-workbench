...
//  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mulh   , R, R(dest) = (( (int64_t)src1 * (int64_t)src2 ) >> 64) );
//  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mulhsu , R, R(dest) = (((int64_t)src1 * src2)  >> 64 ) );
//  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mulhu  , R, R(dest) = (src1 * src2) >> 64 );
//  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", div    , R, R(dest) = ((int64_t)src1 / (int64_t)src2) );
//  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", divu   , R, R(dest) = (src1 / src2) );
//  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", rem    , R, R(dest) = ((int64_t)src1 % (int64_t)src2) );
//  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", remu   , R, R(dest) = (src1 % src2) );
...
//  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", divuw  , R, R(dest) = SEXT(BITS( BITS(src1,31,0) / BITS(src2,31,0),31,0 ),32) );
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw   , R, R(dest) = SEXT(BITS( (int32_t)BITS(src1,31,0) % (int32_t)BITS(src2,31,0),31,0 ),32) );
//  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", remuw  , R, R(dest) = SEXT(BITS( BITS(src1,31,0) % BITS(src2,31,0),31,0 ),32) );
