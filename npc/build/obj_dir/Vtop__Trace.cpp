...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgQData(oldp+322,(vlSelf->snxt_pc),64);
        tracep->chgQData(oldp+324,(vlSelf->dnxt_pc),64);
        tracep->chgBit(oldp+326,(vlSelf->this_ebreak));
        tracep->chgBit(oldp+327,(vlSelf->this_valid));
        tracep->chgQData(oldp+328,(vlSelf->this_pc),64);
        tracep->chgIData(oldp+330,(vlSelf->this_instr),32);
    }
}
