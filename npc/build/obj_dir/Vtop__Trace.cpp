...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+8,(vlSelf->top__DOT__axi_interface_inst__DOT__nstate),8);
        }
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
            ...
            tracep->chgBit(oldp+93,(vlSelf->top__DOT__exu_instr_en));
            tracep->chgIData(oldp+94,(vlSelf->top__DOT__ifu_inst__DOT__instr_reg),32);
            ...
            tracep->chgBit(oldp+318,(vlSelf->top__DOT__axi_interface_inst__DOT__delay_rstn));
            tracep->chgCData(oldp+319,(vlSelf->top__DOT__axi_interface_inst__DOT__cstate),8);
            tracep->chgCData(oldp+320,(vlSelf->top__DOT__axi_interface_inst__DOT__awsize),3);
            tracep->chgCData(oldp+321,(vlSelf->top__DOT__axi_interface_inst__DOT__wstrb),8);
            tracep->chgBit(oldp+322,(vlSelf->top__DOT__hazard_inst__DOT__hazard_rs1));
            tracep->chgBit(oldp+323,(vlSelf->top__DOT__hazard_inst__DOT__hazard_rs2));
            tracep->chgBit(oldp+324,(vlSelf->top__DOT__forward_inst__DOT__ex_forward_1));
            tracep->chgBit(oldp+325,(vlSelf->top__DOT__forward_inst__DOT__ex_forward_2));
            tracep->chgBit(oldp+326,(vlSelf->top__DOT__forward_inst__DOT__mm_forward_1));
            tracep->chgBit(oldp+327,(vlSelf->top__DOT__forward_inst__DOT__mm_forward_2));
        }
        tracep->chgBit(oldp+328,(vlSelf->clk));
        tracep->chgBit(oldp+329,(vlSelf->rstn));
        tracep->chgQData(oldp+330,(vlSelf->pc),64);
        tracep->chgQData(oldp+332,(vlSelf->snxt_pc),64);
        tracep->chgQData(oldp+334,(vlSelf->dnxt_pc),64);
        tracep->chgBit(oldp+336,(vlSelf->this_ebreak));
        tracep->chgBit(oldp+337,(vlSelf->this_valid));
        tracep->chgQData(oldp+338,(vlSelf->this_pc),64);
        tracep->chgIData(oldp+340,(vlSelf->this_instr),32);
        tracep->chgCData(oldp+341,(vlSelf->ARID),4);
        tracep->chgQData(oldp+342,(vlSelf->ARADDR),64);
        tracep->chgCData(oldp+344,(vlSelf->ARLEN),8);
        tracep->chgCData(oldp+345,(vlSelf->ARSIZE),3);
        tracep->chgCData(oldp+346,(vlSelf->ARBURST),2);
        tracep->chgBit(oldp+347,(vlSelf->ARLOCK));
        tracep->chgCData(oldp+348,(vlSelf->ARCACHE),4);
        tracep->chgCData(oldp+349,(vlSelf->ARPORT),3);
        tracep->chgCData(oldp+350,(vlSelf->ARQOS),4);
        tracep->chgCData(oldp+351,(vlSelf->ARREGION),4);
        tracep->chgBit(oldp+352,(vlSelf->ARVALID));
        tracep->chgBit(oldp+353,(vlSelf->ARREADY));
        tracep->chgCData(oldp+354,(vlSelf->RID),4);
        tracep->chgQData(oldp+355,(vlSelf->RDATA),64);
        tracep->chgCData(oldp+357,(vlSelf->RRESP),2);
        tracep->chgBit(oldp+358,(vlSelf->RLAST));
        tracep->chgBit(oldp+359,(vlSelf->RVALID));
        tracep->chgBit(oldp+360,(vlSelf->RREADY));
        tracep->chgCData(oldp+361,(vlSelf->AWID),4);
        tracep->chgQData(oldp+362,(vlSelf->AWADDR),64);
        tracep->chgCData(oldp+364,(vlSelf->AWLEN),8);
        tracep->chgCData(oldp+365,(vlSelf->AWSIZE),3);
        tracep->chgCData(oldp+366,(vlSelf->AWBURST),2);
        tracep->chgBit(oldp+367,(vlSelf->AWLOCK));
        tracep->chgCData(oldp+368,(vlSelf->AWCACHE),4);
        tracep->chgCData(oldp+369,(vlSelf->AWPORT),3);
        tracep->chgCData(oldp+370,(vlSelf->AWQOS),4);
        tracep->chgCData(oldp+371,(vlSelf->AWREGION),4);
        tracep->chgBit(oldp+372,(vlSelf->AWVALID));
        tracep->chgBit(oldp+373,(vlSelf->AWREADY));
        tracep->chgCData(oldp+374,(vlSelf->WID),4);
        tracep->chgQData(oldp+375,(vlSelf->WDATA),64);
        tracep->chgCData(oldp+377,(vlSelf->WSTRB),8);
        tracep->chgBit(oldp+378,(vlSelf->WLAST));
        tracep->chgBit(oldp+379,(vlSelf->WVALID));
        tracep->chgBit(oldp+380,(vlSelf->WREADY));
        tracep->chgCData(oldp+381,(vlSelf->BID),4);
        tracep->chgCData(oldp+382,(vlSelf->BRESP),2);
        tracep->chgBit(oldp+383,(vlSelf->BVALID));
        tracep->chgBit(oldp+384,(vlSelf->BREADY));
        tracep->chgIData(oldp+385,((IData)(vlSelf->RDATA)),32);
    }
}
