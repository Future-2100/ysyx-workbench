...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
            ...
            tracep->chgBit(oldp+2,(vlSelf->top__DOT__exu_inst__DOT__exu_update));
            tracep->chgQData(oldp+3,(vlSelf->top__DOT__mmu_inst__DOT__load_data),64);
            tracep->chgBit(oldp+5,(vlSelf->top__DOT__axi_interface_inst__DOT__posedge_rstn));
            tracep->chgCData(oldp+6,(vlSelf->top__DOT__axi_interface_inst__DOT__nstate),4);
        }
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
            tracep->chgBit(oldp+7,(vlSelf->top__DOT__jump_en));
            tracep->chgQData(oldp+8,(vlSelf->top__DOT__exu_alu_result),64);
            tracep->chgQData(oldp+10,(vlSelf->top__DOT__ifu_pc),64);
            tracep->chgIData(oldp+12,(vlSelf->top__DOT__ifu_instr),32);
            tracep->chgQData(oldp+13,(vlSelf->top__DOT__ifu_snxt_pc),64);
            tracep->chgBit(oldp+15,(vlSelf->top__DOT__ifu_valid));
            tracep->chgBit(oldp+16,(vlSelf->top__DOT__hazard_nop));
            tracep->chgBit(oldp+17,(vlSelf->top__DOT__need_rs1));
            tracep->chgBit(oldp+18,(vlSelf->top__DOT__need_rs2));
            tracep->chgQData(oldp+19,(vlSelf->top__DOT__mmu_wb_data),64);
            tracep->chgCData(oldp+21,(vlSelf->top__DOT__mmu_index_rd),5);
            tracep->chgBit(oldp+22,(vlSelf->top__DOT__mmu_wb_en));
            tracep->chgCData(oldp+23,(vlSelf->top__DOT__idu_index_rs1),5);
            tracep->chgCData(oldp+24,(vlSelf->top__DOT__idu_index_rs2),5);
            tracep->chgCData(oldp+25,(vlSelf->top__DOT__idu_index_rd),5);
            tracep->chgIData(oldp+26,(vlSelf->top__DOT__idu_instr),32);
            tracep->chgCData(oldp+27,(vlSelf->top__DOT__idu_funct3),3);
            tracep->chgCData(oldp+28,(vlSelf->top__DOT__idu_funct7),7);
            tracep->chgBit(oldp+29,(vlSelf->top__DOT__idu_valid));
            tracep->chgQData(oldp+30,(vlSelf->top__DOT__idu_snxt_pc),64);
            tracep->chgQData(oldp+32,(vlSelf->top__DOT__idu_pc),64);
            tracep->chgQData(oldp+34,(vlSelf->top__DOT__idu_data_rs1),64);
            tracep->chgQData(oldp+36,(vlSelf->top__DOT__idu_imm),64);
            tracep->chgQData(oldp+38,(vlSelf->top__DOT__idu_data_rs2),64);
            tracep->chgBit(oldp+40,(vlSelf->top__DOT__idu_add_pc_en));
            tracep->chgBit(oldp+41,(vlSelf->top__DOT__idu_add_rs1_en));
            tracep->chgBit(oldp+42,(vlSelf->top__DOT__idu_add_zero_en));
            tracep->chgBit(oldp+43,(vlSelf->top__DOT__idu_imm_en));
            tracep->chgBit(oldp+44,(vlSelf->top__DOT__idu_rs2_en));
            tracep->chgBit(oldp+45,(vlSelf->top__DOT__idu_addop_en));
            tracep->chgBit(oldp+46,(vlSelf->top__DOT__idu_iop_en));
            tracep->chgBit(oldp+47,(vlSelf->top__DOT__idu_rop_en));
            tracep->chgBit(oldp+48,(vlSelf->top__DOT__idu_mop_en));
            tracep->chgBit(oldp+49,(vlSelf->top__DOT__idu_iwop_en));
            tracep->chgBit(oldp+50,(vlSelf->top__DOT__idu_rwop_en));
            tracep->chgBit(oldp+51,(vlSelf->top__DOT__idu_mwop_en));
            tracep->chgBit(oldp+52,(vlSelf->top__DOT__idu_jal_en));
            tracep->chgBit(oldp+53,(vlSelf->top__DOT__idu_jalr_en));
            tracep->chgBit(oldp+54,(vlSelf->top__DOT__idu_branch_en));
            tracep->chgBit(oldp+55,(vlSelf->top__DOT__idu_load_en));
            tracep->chgBit(oldp+56,(vlSelf->top__DOT__idu_store_en));
            tracep->chgBit(oldp+57,(vlSelf->top__DOT__idu_wb_alu_en));
            tracep->chgBit(oldp+58,(vlSelf->top__DOT__idu_ebreak_en));
            tracep->chgBit(oldp+59,(vlSelf->top__DOT__fwd_en_1));
            tracep->chgBit(oldp+60,(vlSelf->top__DOT__fwd_en_2));
            tracep->chgQData(oldp+61,(vlSelf->top__DOT__fwd_data_rs1),64);
            tracep->chgQData(oldp+63,(vlSelf->top__DOT__fwd_data_rs2),64);
            tracep->chgBit(oldp+65,(vlSelf->top__DOT__exu_jal_en));
            tracep->chgBit(oldp+66,(vlSelf->top__DOT__exu_jalr_en));
            tracep->chgBit(oldp+67,(vlSelf->top__DOT__exu_branch_en));
            tracep->chgBit(oldp+68,(vlSelf->top__DOT__exu_br_result));
            tracep->chgQData(oldp+69,(vlSelf->top__DOT__exu_snxt_pc),64);
            tracep->chgBit(oldp+71,(vlSelf->top__DOT__exu_load_en));
            tracep->chgBit(oldp+72,(vlSelf->top__DOT__exu_store_en));
            tracep->chgCData(oldp+73,(vlSelf->top__DOT__exu_funct3),3);
            tracep->chgQData(oldp+74,(vlSelf->top__DOT__exu_data_rs2),64);
            tracep->chgBit(oldp+76,(vlSelf->top__DOT__exu_wb_alu_en));
            tracep->chgBit(oldp+77,(vlSelf->top__DOT__exu_wb_spc_en));
            tracep->chgBit(oldp+78,(vlSelf->top__DOT__exu_wb_en));
            tracep->chgBit(oldp+79,(vlSelf->top__DOT__exu_ebreak_en));
            tracep->chgCData(oldp+80,(vlSelf->top__DOT__exu_index_rd),5);
            tracep->chgQData(oldp+81,(vlSelf->top__DOT__exu_pc),64);
            tracep->chgIData(oldp+83,(vlSelf->top__DOT__exu_instr),32);
            tracep->chgBit(oldp+84,(vlSelf->top__DOT__exu_valid));
            tracep->chgBit(oldp+85,(vlSelf->top__DOT__mmu_valid));
            tracep->chgBit(oldp+86,(vlSelf->top__DOT__mmu_ebreak_en));
            tracep->chgQData(oldp+87,(vlSelf->top__DOT__mmu_pc),64);
            tracep->chgIData(oldp+89,(vlSelf->top__DOT__mmu_instr),32);
            tracep->chgCData(oldp+90,(vlSelf->top__DOT__mm_wlen),4);
            ...
            tracep->chgQData(oldp+297,(vlSelf->top__DOT__mmu_inst__DOT__mmu_alu_result),64);
            tracep->chgQData(oldp+299,(vlSelf->top__DOT__mmu_inst__DOT__mmu_snxt_pc),64);
            tracep->chgQData(oldp+301,(vlSelf->top__DOT__mmu_inst__DOT__mmu_load_data),64);
            tracep->chgBit(oldp+303,(vlSelf->top__DOT__mmu_inst__DOT__mmu_wb_alu_en));
            tracep->chgBit(oldp+304,(vlSelf->top__DOT__mmu_inst__DOT__mmu_wb_spc_en));
            tracep->chgBit(oldp+305,(vlSelf->top__DOT__mmu_inst__DOT__mmu_load_en));
            tracep->chgBit(oldp+306,((0U == (IData)(vlSelf->top__DOT__exu_funct3))));
            tracep->chgBit(oldp+307,((1U == (IData)(vlSelf->top__DOT__exu_funct3))));
            tracep->chgBit(oldp+308,((2U == (IData)(vlSelf->top__DOT__exu_funct3))));
            tracep->chgBit(oldp+309,((3U == (IData)(vlSelf->top__DOT__exu_funct3))));
            tracep->chgBit(oldp+310,((4U == (IData)(vlSelf->top__DOT__exu_funct3))));
            tracep->chgBit(oldp+311,((5U == (IData)(vlSelf->top__DOT__exu_funct3))));
            tracep->chgBit(oldp+312,((6U == (IData)(vlSelf->top__DOT__exu_funct3))));
            tracep->chgBit(oldp+313,((7U == (IData)(vlSelf->top__DOT__exu_funct3))));
            tracep->chgBit(oldp+314,(vlSelf->top__DOT__axi_interface_inst__DOT__delay_rstn));
            tracep->chgCData(oldp+315,(vlSelf->top__DOT__axi_interface_inst__DOT__cstate),4);
            tracep->chgQData(oldp+316,(vlSelf->top__DOT__axi_interface_inst__DOT__mm_raddr),64);
        ...
        tracep->chgBit(oldp+358,(((IData)(vlSelf->top__DOT__exu_load_en)
