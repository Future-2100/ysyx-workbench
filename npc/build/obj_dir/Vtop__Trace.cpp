...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
            tracep->chgBit(oldp+0,(vlSelf->top__DOT__instr_valid));
        ...
        tracep->chgCData(oldp+341,(vlSelf->ARPORT),3);
        tracep->chgBit(oldp+342,(vlSelf->ARVALID));
        tracep->chgBit(oldp+343,(vlSelf->ARREADY));
        tracep->chgQData(oldp+344,(vlSelf->RDATA),64);
        tracep->chgCData(oldp+346,(vlSelf->RRESP),2);
        tracep->chgBit(oldp+347,(vlSelf->RVALID));
        tracep->chgBit(oldp+348,(vlSelf->RREADY));
        tracep->chgIData(oldp+349,((IData)(vlSelf->RDATA)),32);
    }
}
