...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+2,(vlSelf->top__DOT__axi_interface_inst__DOT__nstate),4);
            tracep->chgBit(oldp+3,(vlSelf->top__DOT__axi_interface_inst__DOT__rresp_data_en));
        }
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
            ...
            tracep->chgBit(oldp+315,(vlSelf->top__DOT__axi_interface_inst__DOT__delay_rstn));
            tracep->chgCData(oldp+316,(vlSelf->top__DOT__axi_interface_inst__DOT__cstate),4);
            tracep->chgQData(oldp+317,(vlSelf->top__DOT__axi_interface_inst__DOT__mm_raddr),64);
