...
VL_INLINE_OPT void Vtop___024root___combo__TOP__9(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__instr_valid = (((IData)(vlSelf->RREADY) 
                                      & (IData)(vlSelf->RVALID)) 
                                     & (0U == (IData)(vlSelf->RRESP)));
                               ...
                               ? (((IData)(vlSelf->ARREADY) 
                                   ...
                                   ? 2U : 1U) : ((2U 
                                                 ...
                                                 (((IData)(vlSelf->RVALID) 
                                                   ...
                                                   : 2U)
                                                  : 0U)));
    if (((IData)(vlSelf->top__DOT__instr_valid) ^ (IData)(vlSelf->top__DOT____Vtogcov__instr_valid))) {
        ++(vlSymsp->__Vcoverage[446]);
        vlSelf->top__DOT____Vtogcov__instr_valid = vlSelf->top__DOT__instr_valid;
    }
    vlSelf->dnxt_pc = ((IData)(vlSelf->top__DOT__jump_en)
                        ? vlSelf->top__DOT__exu_alu_result
                        : ((1U & ((IData)(vlSelf->top__DOT__hazard_nop) 
                                  | (~ (IData)(vlSelf->top__DOT__instr_valid))))
