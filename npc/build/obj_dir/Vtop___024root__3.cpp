...
VL_INLINE_OPT void Vtop___024root___combo__TOP__9(Vtop___024root* vlSelf) {
    ...
    if ((((IData)(vlSelf->top__DOT__exu_load_en) ? (IData)(vlSelf->top__DOT__axi_interface_inst__DOT__rresp_data_en)
           : (IData)(vlSelf->top__DOT__axi_interface_inst__DOT__rresp_instr_en)) 
         ^ (IData)(vlSelf->top__DOT__mmu_inst__DOT____Vtogcov__mmu_update))) {
        ++(vlSymsp->__Vcoverage[4228]);
        vlSelf->top__DOT__mmu_inst__DOT____Vtogcov__mmu_update 
            = ((IData)(vlSelf->top__DOT__exu_load_en)
                ? (IData)(vlSelf->top__DOT__axi_interface_inst__DOT__rresp_data_en)
                : (IData)(vlSelf->top__DOT__axi_interface_inst__DOT__rresp_instr_en));
    }
    vlSelf->top__DOT__exu_inst__DOT__exu_update = ((IData)(vlSelf->top__DOT__exu_load_en)
                                                    ? (IData)(vlSelf->top__DOT__axi_interface_inst__DOT__rresp_data_en)
                                                    : (IData)(vlSelf->top__DOT__axi_interface_inst__DOT__rresp_instr_en));
    ...
    if (((IData)(vlSelf->top__DOT__exu_inst__DOT__exu_update) 
         ^ (IData)(vlSelf->top__DOT____Vtogcov__this_update))) {
        ++(vlSymsp->__Vcoverage[1637]);
        vlSelf->top__DOT____Vtogcov__this_update = vlSelf->top__DOT__exu_inst__DOT__exu_update;
    }
